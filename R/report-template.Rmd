...
```{r echo=FALSE}
report_biomass <- "Fish Biomass" %in% input$report_metrics
report_fish_density <- "Fish Density" %in% input$report_metrics
```
...
if(report_biomass) print("biomass goes here")
```
```{asis, echo=report_biomass}
...
if(report_fish_density) print("fish density goes here")
```
```{asis echo=report_fish_density}
